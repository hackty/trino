...
import static io.trino.plugin.gaussdb.TypeUtils.*;
...
{
    private static final Logger log = Logger.get(GaussDbClient.class);
...
//        }
        ...
        this.aggregateFunctionRewriter = new AggregateFunctionRewriter<>(
                ...
                ImmutableSet.<AggregateFunctionRule<JdbcExpression, String>>builder()
                        ...
                        .add(new ImplementSum(GaussDbClient::toTypeHandle))
    ...
    public WriteMapping toWriteMapping(ConnectorSession session, Type type)
    {
        ...
        if (type instanceof TimestampType) {
            ...
            if (timestampType.getPrecision() <= POSTGRESQL_MAX_SUPPORTED_TIMESTAMP_PRECISION) {
                ...
                return WriteMapping.longMapping(format("timestamp(%s)", timestampType.getPrecision()), GaussDbClient::shortTimestampWriteFunction);
            }
            verify(timestampType.getPrecision() > TimestampType.MAX_SHORT_PRECISION);
